...
data class DialogueChapterEntity(
    ...
    val readingTurns: String,
    val readingGlossary: String,
    val readingQuestions: String,
    val listeningTurns: String,
    val listeningGlossary: String,
    val listeningQuestions: String,
